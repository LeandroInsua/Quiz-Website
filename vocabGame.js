...
/* kANJI */
let vocabData = []; //current game kanji
...
function showVocab() {
    ...
    // CORRECT READING
    const correctReading = currentWord.english;
    ...
    while (answers.size < choices.length) {
        ...
        const wrongReading = randomWord.english;
    ...
    // Remove used kanji
    vocabData.splice(questionIndex, 1);
...
nextQuestion.addEventListener("click", () => {
    ...
    //END GAME
    if(questionCounter >= wordChoices.length){
